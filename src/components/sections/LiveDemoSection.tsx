...
export function LiveDemoSection({ onCrash }: LiveDemoSectionProps) {
  ...
  const handleSubmit = () => {
    ...
    // Second prompt triggers crash
    if (newCount === 2) {
      setRunning(true);
      const userPrompt = prompt;
      setPrompt("");
      setLog((prev) => [...prev, `> ${userPrompt}`, "🤖 Thinking..."]);

      window.setTimeout(() => {
        setLog((prev) => [
          ...prev,
          "⚠️ CRITICAL ERROR: System overload detected!",
          "💥 Memory corruption in progress...",
          "🔥 Stack overflow imminent...",
          "💀 FATAL: Application will now terminate.",
        ]);
      }, 800);
    ...
    window.setTimeout(() => {
      ...
      setDiffLines([
        ...
        "+++ b/src/app/page.tsx",
        "@@ -1,6 +1,9 @@",
        `+// TODO: auto-generated by ${SITE_CONFIG.name}`,
          ...
          <div className="w-full">
            ...
            <div className="section-card mt-6 border-8 border-[#ff0000] bg-[#00ffff] p-4 text-black shadow-[8px_8px_0_#ff00ff] sm:p-6">
              ...
              >
                ...
                <button
                  type="submit"
                  className={`border-8 border-[#ff0000] bg-[#00ffff] px-4 py-3 text-[16px] font-bold text-black transition-transform sm:px-6 sm:text-[18px] ${
                    buttonShake ? "animate-[shake_0.4s_ease-in-out]" : ""
                  }`}
                  disabled={running}
                >
